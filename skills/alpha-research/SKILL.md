...
Run `alpha login` to authenticate with alphaXiv. Check status with `feynman-opl alpha status`, or `alpha status` once your installed `alpha-hub` version includes it.
